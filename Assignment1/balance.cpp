...
public:
	...
	void show()
	{
		cout<<endl<<"Account number: "
			<<ac_no<<endl
			<<"Date of last update: "
			<<last_update<<"Balance: "<<balance<<endl<<endl;
	}
...
int main()
{
	...
	do
	{
				cout<<"1. Add new account"<<endl
					<<"2. Transact with existing account"<<endl
					<<"3. Details of an account"<<endl
					<<"4. Get transactions for an account"<<endl
					<<"5. Exit"<<endl<<"Enter choice"<<endl;
		cin>>ch;
